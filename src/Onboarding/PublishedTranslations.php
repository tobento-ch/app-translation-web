...
final class PublishedTranslations implements PublishedTranslationsInterface
{
    /**
     * Create a new PublishedTranslations instance.
     *
     * @param string $locale The locale whose translations were published.
     * @param string $appId The application identifier.
     * @param SavedTranslationsInterface $saved The translations that were published.
     */
